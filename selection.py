...
class plot_kinematics(result_function):
	def __init__(self):
		...
		self.names = dict((name,(binning,high,low,xlabel)) for name,binning,high,low,xlabel in [
			...
			('transverse_W_mass',50,0.,200000.,"(M_{T}(l_{1},MET),M_{T}(l_{2},MET)) [MeV]"),
			...
			('lepton_pair_mass_low',56,10000.,45000.,"M_{T}(l_{1},MET) [MeV]"),
			('lepton_dR_original',60,0.,6.,"\Delta R(l_{1},l_{2})"),
			('lepton_dR',60,0.,6.,"\Delta R(l_{1},l_{2})"),
			...
			('lepton_pair_pT_diff',60,0.,60000.,"abs(p_{T}^{l_{1}}-p_{T}^{l_{2}}) [MeV]"),
