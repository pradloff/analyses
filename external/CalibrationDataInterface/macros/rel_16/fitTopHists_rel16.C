...
void fitTopHists_rel16(TString TaggerName = "SV0",
		       TString OPName = "5_85",
		       TString OutFileName = "TopCalibrations_rel16_prelim.root",
		       ...
		       bool prelim = false)
{
 ...
 // old rel 15 file:
  ...
  // files provided by Martin zur Nedden:
  if (prelim)
    file_rel16 = new TFile("ttbar7_first_rel16.root", "read");
  else 
    // latest:
    file_rel16 = new TFile("ttbar7.root", "read");
  ...
  if (doOwnRatios) {
    ...
    /*
      {
    TString dirname = "btag/AntiKt4TopoEM/" + TaggerName + "/";
    TString name = "h_btag_AntiKt4TopoEM_JetProb_beff_eta_Et_cut1";
    hb = GetHisto2DFromFile(file_rel16, dirname, name);
    name = "h_btag_AntiKt4TopoEM_JetProb_ceff_eta_Et_cut1";
    hc = GetHisto2DFromFile(file_rel16, dirname, name);
    dirname = "btag/AntiKt4TopoEM/" + TaggerName + "/";
    name = "h_btag_AntiKt4TopoEM_JetProb_udseff_eta_Et_cut1";
    hlight = GetHisto2DFromFile(file_rel16, dirname, name);
  } else if (OPName == "2_05") {
    TString dirname = "btag/AntiKt4TopoEM/" + TaggerName + "/";
    TString name = "h_btag_AntiKt4TopoEM_JetProb_beff_eta_Et_cut2";
    hb = GetHisto2DFromFile(file_rel16, dirname, name);
    name = "h_btag_AntiKt4TopoEM_JetProb_ceff_eta_Et_cut2";
    hc = GetHisto2DFromFile(file_rel16, dirname, name);
    dirname = "btag/AntiKt4TopoEM/" + TaggerName + "/";
    name = "h_btag_AntiKt4TopoEM_JetProb_udseff_eta_Et_cut2";
    hlight = GetHisto2DFromFile(file_rel16, dirname, name);
  }
    */
  ...
  TF1* fbSelectionSF = new TF1("bSFFunction", HeavyFlavourSF, bptmin, bptmax, 0);
  ...
  TF1* fbSelectionSFSyst = new TF1("fbSelectionSFSyst", HeavyFlavourSFSyst, bptmin, bptmax, 1);
  ...
  TF1* fcSelectionSFSyst = new TF1("fcSelectionSFSyst", HeavyFlavourSFSyst, bptmin, bptmax, 1);
