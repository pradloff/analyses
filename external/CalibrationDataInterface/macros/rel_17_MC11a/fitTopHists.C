...
void fitTopHists(TString TaggerName = "SV0",
		 TString OPName = "5_65",
		 TString OutFileName = "TopCalibrations_rel17_MC11a_new.root",
		 ...
		 bool prelim = false)
{
  ...
  setup();
  cout << endl;
  cout << "=== Running fitTopHists_rel17, MC11a ===" << endl;
  cout << endl;
  ...
  if (SV0Fit) {
    ...
    cout << "OK, setting SV0Fit params..." << endl;
  } else if (JetFitNNFit) {
    parb[0] = 0.4;  parb[1] = 0.03;  parb[2] = 0;  parb[3] = 0;  parb[4] = -0.04;  parb[5] = 0;
    parb[6] = 0.;    parb[7] = 0.; // parb[8] = 0.;
    cout << "OK, setting JetFitNNFit params..." << endl;
  } else if (JetFitNN57Fit) {
    parb[0] = 0.4;  parb[1] = 0.03;  parb[2] = 0;  parb[3] = 0;  parb[4] = -0.04;  parb[5] = 0;
