...
EisoTool2012::~EisoTool2012()
{
//   if( h_etconeCor20 ) {delete h_etconeCor20;}
//   if( h_etconeCor30 ) {delete h_etconeCor30;}
//   if( h_etconeCor40 ) {delete h_etconeCor40;}
//   if( h_ptcone20 ) {delete h_ptcone20;}
//   if( h_ptcone30 ) {delete h_ptcone30;}
//   if( h_ptcone40 ) {delete h_ptcone40;}
//   if( h_topoconeCor20 ) {delete h_topoconeCor20;}
//   if( h_topoconeCor30 ) {delete h_topoconeCor30;}
//   if( h_topoconeCor40 ) {delete h_topoconeCor40;}
//   if( h_etBins ) {delete h_etBins;}
//   if( h_etaBins ) {delete h_etaBins;}
}
...
void EisoTool2012::LoadHistograms()
{
  ...
  // ROOT does not own the hitograms, EisoTool2012 does
