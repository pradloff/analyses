...
void plotEResolution_ERUpgrade(double eta){
   ...
   while( i <= nPts ) {
     ...
     gTotUp->SetPoint( i, e/cosh(eta), erup );
     gTotDown->SetPoint( i, e/cosh(eta), erdo );
     gTotRelUp->SetPoint( i, e/cosh(eta), erup/ers.resolution( e, eta, true ) );
     gTotRelDown->SetPoint( i, e/cosh(eta), erdo/ers.resolution( e, eta, true ) );

     gCstUp->SetPoint( i, e/cosh(eta), ers.dataConstantTermUpError( eta ) );
     gCstDown->SetPoint( i, e/cosh(eta), ers.dataConstantTermDownError( eta ) );
   ...
   gTotUp->GetXaxis()->SetTitle("E_{T} [GeV]");
   gTotUp->Draw("AL");
   ...
   gTotRelUp->GetXaxis()->SetTitle("E_{T} [GeV]");
   gTotRelUp->Draw("AL");
