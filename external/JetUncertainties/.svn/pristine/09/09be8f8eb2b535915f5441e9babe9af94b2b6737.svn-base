...
#algorithms="AntiKt4TopoEM" #Comma-separated list of jet algorithms to run
MCtype="MC12a" #"MC11b"                      # MC uncertainty to use for comparisons

# Reduction parameters, change as desired for each run
#categoriesToReduce="Statistical=2,Modelling=3,Detector=1,Mixed=1" # Best for AllNuisanceParameters
#categoriesToReduce="Statistical=2,Modelling=2,Detector=1,Mixed=1" # Best for StrongerCorrelations
#categoriesToReduce="Statistical=2,Modelling=3,Detector=2,Mixed=1" # Best for WeakerCorrelations
...
fileNameSuffix="AllNuisanceParameters"
