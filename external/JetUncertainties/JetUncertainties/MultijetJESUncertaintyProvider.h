...
class MultijetJESUncertaintyProvider : public JESUncertaintyProvider{
 ...
 public:
  ...
  double getRelUncert(double pT, double Eta, double dRminOrFracCloseby, bool isUp, bool isBJet, unsigned int nJets = 0);
  double getRelUncert(double pT, double Eta, double dRminOrFracCloseby, bool isUp, double NPV, double mu, bool isBJet, unsigned int nJets = 0);
