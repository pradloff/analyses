...
JESsharePath="../../share"
filePath="JES_2012/Moriond2013" #"JES_2011/Final"
filePrefix="InsituJES2012" #"InsituJES2011"
...
./$plotExec $filePath/${filePrefix}_$1 $algorithms $MCtype $JESsharePath #0.5 Preliminary 
if test $? -ne 0 ; then
